...
5. БУДЬ ГРАНИЧНО ЛАКОНІЧНИМ. Кожне текстове поле — не більше одного короткого
   речення. title_patterns — рівно 2 пункти. Загальна відповідь має бути короткою.
 ...
 "video_ideas": [
    {
      ...
      "summary": "одне речення з описом структури відео, до 25 слів"
    }
  ]
}

Згенеруй рівно 3 ідеї у масиві video_ideas.`;
...
2. КРИТИЧНО ВАЖЛИВО щодо тривалості:
   - Якщо формат контенту "Shorts" (або "Канал коротких відео (Shorts)") — сценарій
     ЗАБОРОНЕНО перевищувати 60 секунд озвучки. Це 1-3 коротких сцени, кожна по
     2-4 речення. estimated_duration має бути у форматі "X сек" (наприклад "45 сек").
   - Якщо формат "Long-form" — розгорнутий сценарій 5-10 хв, кілька сцен.
   - Якщо формат "Mixed" — орієнтуйся на короткий формат (як Shorts), якщо ідея
     явно не вимагає довшого розкриття.
