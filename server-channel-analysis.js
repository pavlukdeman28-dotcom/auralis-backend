...
5. БУДЬ МАКСИМАЛЬНО ЛАКОНІЧНИМ. title_patterns — рівно 3 пункти, кожен до 12 слів.
   content_tone — одне речення, до 15 слів. hook — одне речення. outline — рівно
   3 пункти, кожен до 10 слів. Це критично важливо, щоб відповідь повністю
   вмістилась у ліміт токенів.
